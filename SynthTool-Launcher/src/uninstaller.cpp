...
int main(int argc, char* argv[]) {
    ...
    app.setApplicationName("SynthTool-Uninstaller");

    // Standard styling for QMessageBox
    QMessageBox::StandardButton reply;
    reply = QMessageBox::question(nullptr, "Uninstall SynthTool-Launcher",
        "Are you sure you want to completely uninstall SynthTool-Launcher?\n\n"
    ...
    QMessageBox::information(nullptr, "Uninstall Success",
        "✓ SynthTool-Launcher has been successfully uninstalled!\n\n"
