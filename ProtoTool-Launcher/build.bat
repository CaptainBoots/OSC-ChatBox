...
echo [INFO] Compiling ProtoTool-Uninstaller.spec with PyInstaller...
python -m PyInstaller --noconfirm ProtoTool-Uninstaller.spec

if %errorlevel% neq 0 (
    echo.
    echo [ERROR] ProtoTool-Uninstaller Compilation failed!
    pause
    exit /b 1
)
